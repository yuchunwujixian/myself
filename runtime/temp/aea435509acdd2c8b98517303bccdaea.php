<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\www\lisan\public/../application/admin\view\user\edit.html";i:1525182246;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="content">
                                <form id="edit-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="<?php echo url('admin/user/edit'); ?>">
                                        <input name="id" value="<?php echo $row['id']; ?>" type="hidden" >
                                    <div class="form-group">
                                        <label for="username" class="control-label col-xs-12 col-sm-2">用户名:</label>
                                        <div class="col-xs-12 col-sm-8">
                                            <input type="text" class="form-control" id="username" name="row[user_name]" value="<?php echo $row['user_name']; ?>" data-rule="required;username" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <div class="form-inline">
                                                <input id="c-avatar" class="form-control" size="50" name="row[avatar]" value="<?php echo $row['avatar']; ?>" type="text" value="">
...
<!--                                                 <span><button type="button" id="fachoose-image" class="btn btn-primary fachoose" data-multiple="false" data-input-id="c-image"><i class="fa fa-list-ul"></i> 选择</button></span> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input type="text" class="form-control" id="mobile" name="row[mobile]" value="<?php echo $row['mobile']; ?>" />
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <label for="row[sex]-normal"><input id="row[sex]-normal" <?php if($row['sex']=='1'): ?>checked="checked"<?php endif; ?> name="row[sex]" type="radio" value="1"> 男</label> 
                                            <label for="row[sex]-hidden"><input id="row[sex]-hidden" <?php if($row['sex']=='2'): ?>checked="checked"<?php endif; ?> name="row[sex]" type="radio" value="2"> 女</label>
                                             <label for="row[sex]-hidden"><input id="row[sex]-hidden" <?php if($row['sex']=='0'): ?>checked="checked"<?php endif; ?> name="row[sex]" type="radio" value="0"> 保密</label>
                                        </div>
                                    </div>                                                                          
