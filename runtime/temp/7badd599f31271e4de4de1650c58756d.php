<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\www\lisan\public/../application/admin\view\goods\add.html";i:1525182246;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="content">
                                <form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('admin/goods/add'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-goods_name" data-rule="required" class="form-control" name="row[goods_name]" type="text" value="" data-rule="required">
                                        </div>
                                    </div>
...
<!--                                     <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-price" class="form-control" name="row[price]" type="text" value="">
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <div class="form-inline">
                                                <input id="c-picture" class="form-control" size="50" name="row[picture]" type="text" value="">
...
<!--                                                 <span><button type="button" id="fachoose-image" class="btn btn-primary fachoose" data-multiple="false" data-input-id="c-image"><i class="fa fa-list-ul"></i> 选择</button></span> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <div class="form-inline">
                                                <input id="c-image" class="form-control" size="50" name="row[images]" type="text" value="">
...
<!--                                                 <span><button type="button" id="fachoose-image" class="btn btn-primary fachoose" data-multiple="false" data-input-id="c-image"><i class="fa fa-list-ul"></i> 选择</button></span> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-unit" data-rule="required" class="form-control" name="row[unit]" type="text" value="">
                                        </div>
                                    </div>                                    
...
<!--                                     <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-freight" data-rule="required" class="form-control" name="row[freight]" type="text" value="0">
                                        </div>
                                    </div> -->
...
<!--                                     <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-stock" data-rule="required" class="form-control" name="row[stock]" type="text" value="0">
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-volume" data-rule="required" class="form-control" name="row[volume]" type="text" value="0">
                                        </div>
                                    </div>                                                                       
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-introduction" class="form-control" name="row[introduction]" type="text" value="">
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <textarea id="c-description" class="form-control summernote" name="row[description]"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <label for="row[status]-normal"><input id="row[status]-normal" checked="checked" name="row[status]" type="radio" value="normal"> 立即上架</label> 
                                            <label for="row[status]-hidden"><input id="row[status]-hidden" name="row[status]" type="radio" value="hidden"> 放入仓库</label>
                                        </div>
                                    </div>
        ...
        var getGoodsInfo_url="<?php echo url('admin/goods/getGoodsInfo'); ?>";
        </script>
        <script type="text/javascript">
