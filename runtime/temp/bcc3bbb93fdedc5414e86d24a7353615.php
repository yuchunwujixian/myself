<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\www\lisan\public/../application/admin\view\admin\index.html";i:1525182246;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
    ...
    <body class="inside-header inside-aside ">
        ...
        <script type="text/javascript">
            var url="<?php echo url('admin/admin/index'); ?>";
            var add_url="<?php echo url('admin/admin/add'); ?>";
            var edit_url="<?php echo url('admin/admin/edit'); ?>";
            var del_url="<?php echo url('admin/admin/delete'); ?>";
        </script>
        <script type="text/javascript">
    var debug="<?php echo $app_debug; ?>";
    var version="<?php echo VERSION; ?>";
    var root="__STATIC__";
    var jsname="backend/admin/index";
