<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\www\lisan\public/../application/admin\view\user\index.html";i:1536927870;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
    ...
    <body class="inside-header inside-aside ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div id="ribbon">
                                ...
                                <ol class="breadcrumb pull-right">
                                    <li><a href="javascript:;" data-url="auth">会员管理</a></li>
                                    <li><a href="javascript:;" data-url="auth/admin">会员列表</a></li>
                                </ol>
                            </div>
                            <!-- END RIBBON -->
                            <div class="content">
        ...
        <script type="text/javascript">
            var url="<?php echo url('admin/user/index'); ?>";
            var add_url="<?php echo url('admin/user/add'); ?>";
            var edit_url="<?php echo url('admin/user/edit'); ?>";
            var del_url="<?php echo url('admin/user/delete'); ?>";
            var sync_url="<?php echo url('admin/user/userSync'); ?>";
        </script>
        <script type="text/javascript">
