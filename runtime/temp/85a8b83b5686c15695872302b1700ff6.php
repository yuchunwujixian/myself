<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"F:\www\lisan\public/../application/admin\view\goods\attributeedit.html";i:1525182246;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="content">
                                <form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('admin/goods/attributeEdit'); ?>">
                                    <input type="hidden" name="attr_id" value="<?php echo $row['attr_id']; ?>">

                                    <div class="form-group">
                                        <label for="c-attr_name" class="control-label col-xs-12 col-sm-2">类型名称:</label>
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="c-attr_name" data-rule="required" class="form-control" name="row[attr_name]" value="<?php echo $row['attr_name']; ?>" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <?php if(is_array($spec) || $spec instanceof \think\Collection || $spec instanceof \think\Paginator): $i = 0; $__LIST__ = $spec;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <input name="row[spec_id_array][]" type="checkbox" value="<?php echo $vo['spec_id']; ?>" <?php if(in_array($vo['spec_id'],$row['spec_id_array'])): ?>checked<?php endif; ?>> <?php echo $vo['spec_name']; if($vo['spec_desc']): ?>[<?php echo $vo['spec_desc']; ?>]<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
                                    </div>                                    
