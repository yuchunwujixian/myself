<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\www\lisan\public/../application/admin\view\position\index.html";i:1525182246;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
    ...
    <body class="inside-header inside-aside ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div id="ribbon">
                                ...
                                <ol class="breadcrumb pull-right">
                                    <li><a href="javascript:;" data-url="category">广告位管理</a></li>
                                </ol>
                            </div>
                            <!-- END RIBBON -->
                            <div class="content">
        ...
        var index_url="<?php echo url('admin/position/index'); ?>";
        var add_url="<?php echo url('admin/position/add'); ?>";
        var edit_url="<?php echo url('admin/position/edit'); ?>";
        var del_url="<?php echo url('admin/position/delete'); ?>";
        var multi_url="<?php echo url('admin/position/multi'); ?>";
        var adsense_url="<?php echo url('admin/position/adsense'); ?>";
        </script>
       <script type="text/javascript">
    var debug="<?php echo $app_debug; ?>";
    var version="<?php echo VERSION; ?>";
    var root="__STATIC__";
    var jsname="backend/position/index";
