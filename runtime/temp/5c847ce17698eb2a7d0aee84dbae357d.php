<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\www\lisan\public/../application/admin\view\group\index.html";i:1525182246;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
    ...
    <body class="inside-header inside-aside ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div id="ribbon">
                                ...
                                <ol class="breadcrumb pull-right">
                                    <li><a href="javascript:;" data-url="category">会员分组列表</a></li>
                                </ol>
                            </div>
                            <!-- END RIBBON -->
                            <div class="content">
        ...
        var index_url="<?php echo url('admin/group/index'); ?>";
        var add_url="<?php echo url('admin/group/add'); ?>";
        var edit_url="<?php echo url('admin/group/edit'); ?>";
        var del_url="<?php echo url('admin/group/delete'); ?>";
        var multi_url="<?php echo url('admin/group/multi'); ?>";
        </script>
       <script type="text/javascript">
    var debug="<?php echo $app_debug; ?>";
    var version="<?php echo VERSION; ?>";
    var root="__STATIC__";
    var jsname="backend/group/index";
