<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\www\lisan\public/../application/admin\view\goods\category.html";i:1536679416;s:62:"F:\www\lisan\public/../application/admin\view\public\head.html";i:1525182246;s:68:"F:\www\lisan\public/../application/admin\view\public\javascript.html";i:1525182246;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        <head>
        <meta charset="utf-8">
    ...
    <body class="inside-header inside-aside ">
        ...
        var index_url="<?php echo url('admin/goods/category'); ?>";
        var add_url="<?php echo url('admin/goods/categoryAdd'); ?>";
        var edit_url="<?php echo url('admin/goods/categoryEdit'); ?>";
        var del_url="<?php echo url('admin/goods/categoryDelete'); ?>";
        var sync_url="<?php echo url('admin/goods/categorySync'); ?>";
        </script>
       <script type="text/javascript">
